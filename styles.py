EXAMPLES = [
    "What is the total sales amount across all records?",
    "Find the top 5 products by total quantity sold",
    "List the average unit price for each product category",
]
...
<div class="dr-brand">
    ...
    <div class="dr-titles">
        <h1>Excel<span class="dr-sep">/</span>SQL Agent</h1>
        <p>Agentic database analysis & Q&A cache</p>
    </div>
</div>
"""
